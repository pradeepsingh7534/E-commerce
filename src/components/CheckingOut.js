...
import PriceName from "./checkingPriceName";


function CheckingOut(){

  const state = useSelector((state)=> state.cartR)
  const array = state.arrCart;
              ...
              <div className="bg-light p-30 mb-5">
                <div className="border-bottom">
                  ...
                  {/* <div className="d-flex justify-content-between">
                    <p>{array[0].product.title}</p>
                    <p>$150</p>
                  </div> */}
                  {array.map((e)=> <PriceName product={e}></PriceName>)}
                </div>
                <div className="border-bottom pt-3 pb-2">
                  <div className="d-flex justify-content-between mb-3">
                    <h6>Subtotal</h6>
                    <h6>${totalPrice(array)}</h6>
                  </div>
                  <div className="d-flex justify-content-between">
                ...
                <div className="pt-2">
                  <div className="d-flex justify-content-between mt-2">
                    <h5>Total</h5>
                    <h5>${(totalPrice(array)+ Number(10)).toFixed(2)}</h5>
                  </div>
                </div>
              </div>
              <div className="mb-5">
                ...
                <div className="bg-light p-30">
                  ...
                  <Link to="/order" className="btn btn-block btn-primary font-weight-bold py-3">
                    Place Order
                  </Link>
                </div>
              </div>
